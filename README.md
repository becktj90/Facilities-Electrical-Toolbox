...
| **Panel Schedule OCR** | Revit panel schedule image OCR, editable circuit rows, half-sheet print layout (`panel-schedule.html`) |
...
4. Open **Panel Schedule OCR** from the Tools section when you need schedule image extraction and print output.
